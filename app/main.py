...
from .models import Article, ContentStatus
...
def seed_silent_desk_article(db):
...
<p>Every time you type, use a mouse, or place down a mug, hard desktop surfaces reflect high-frequency vibrations back into your wrists and ears.</p>
<ul>
...
<li><strong>Key Features:</strong> 4mm+ thickness, natural wool felt surface, rubberized non-slip grip underneath.</li>
...
<li><strong>Key Features:</strong> Hot-swappable PCB, sound-dampening silicone internal pads, factory-lubricated switches.</li>
...
<li><strong>Key Features:</strong> Breathable memory foam/velour pads, lightweight headband distribution (&lt;250g), detachable cabling.</li>
...
<li><strong>Key Features:</strong> Reinforced C-clamp with rubber dampeners, solid aluminum build, independent gas-spring tension.</li>
...
<li><strong>Key Features:</strong> Color temperature adjustment (2700K - 4000K), flicker-free certification, zero screen reflection.</li>
...
try:
    ...
    # 3. إنشاء مقال بيئة العمل الصامتة الحسيّة
    seed_silent_desk_article(db)
